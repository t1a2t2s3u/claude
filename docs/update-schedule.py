...
rows = [
    ...
    ("自社サイト", "ブログ記事", "月1本", "月末までに1本", 90, 1, "★★☆",
     "検索の入り口を増やす。本数より、疑問にきちんと答える質のほうが効く",
     "「ブログネタ帳」シート参照。下書きはClaudeに依頼し、内容の確認に集中する"),
...
ws3["A1"] = "ブログネタ帳　— 月1本のストック。下書きはClaudeに依頼できます"
...
topics = [
    ...
    ("外壁の色選びのコツと失敗例", "外壁塗装 色 選び方 失敗", "いつでも", "未着手",
     "施工事例の写真を使う。カラーシミュレーションの話も"),
