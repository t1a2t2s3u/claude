...
topics = [
    ("秋田市の外壁塗装に使える補助金・助成金", "秋田市 外壁塗装 補助金", "4月（毎年更新）", "公開済み",
     "2026-08-26 公開（/blog/2026-08-akita-gaiheki-hojokin/）。毎年4月に新年度の数値へ更新する"),
    ...
    ("外壁の色選びのコツと失敗例", "外壁塗装 色見本(2,400) / 人気色(1,900) / 色選び シュミレーション(1,900)", "いつでも", "公開済み",
     "2026-09-07 公開（/blog/2026-09-gaiheki-iro-erabi/）。カラーシミュレーション需要の受け皿"),
    ...
    ("外壁塗装を20年していないとどうなる？", "外壁塗装 20年してない / 30年してない（知恵袋の質問需要1位）", "9月後半", "下書き済み",
     "drafts/2026-09-gaiheki-20nen.md（2026-09-06 下書き・本人確認済み）。2026-09-15 公開予約済み"),
